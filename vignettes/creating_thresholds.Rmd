...
**Note:** This is the data we will use to create our thresholds, but you can use any data you have for your sites (cleaned/uncleaned). The more data you have, the better your thresholds will be. You can start with as little as a year of data, though shorter records increase the risk of overfitting thresholds to patterns in that period. This method is not recommended if you do not have a full year's worth of data.
