...
vignette: >
  %\VignetteIndexEntry{Fixing Calibrations}
...
load_calibration_data(
  cal_data_file_path = here::here("..", "poudre_sonde_network", "data", "collated", "sensor", "cal_reports", "munged_calibration_data.RDS"),
  update = TRUE,
  field_cal_dir = here::here("..", "poudre_sonde_network", "data", "raw", "sensor", "calibration_reports")
)
```
...
sensor_data <- arrow::read_parquet(
  here::here("..", "poudre_sonde_network", "data", "collated", "sensor", "compiled_ross_sensor_data_2026-07-15.parquet"),
  as_data_frame = TRUE
) %>%
...
```{r save-cal-data}
write_rds(calibrated_data, here::here("..", "poudre_sonde_network","data", "raw", "sensor", "manual_data_verification", "complete_dataset", "calibrated_sensor_data_2026-08-04.rds"))
```
