...
invisible(
  lapply(c(
    ...
    "httr2", # HTTP requests to the HydroVu/mWater APIs
    "tidyverse", # Data manipulation
    "lubridate", # Date-Time manipulation
    "zoo", # Rolling window calculations
    "padr", # Padding time series with missing intervals
    "stats",
    "RcppRoll", # Rolling window statistics
    "yaml", # Reading credential and threshold files
